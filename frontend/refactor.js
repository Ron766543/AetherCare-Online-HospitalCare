...
// modify the root div wrapper to add dark classes
...
// also remove activeImageIndex from Details as it was moved to Hero
content = content.replace('const [activeImageIndex, setActiveImageIndex] = useState(0);\\n', '');
// Wait, might just be empty string
content = content.replace(/\\s*const \\[activeImageIndex, setActiveImageIndex\\] = useState\\(0\\);/, '');

// Fix modal classes for dark theme
...
content = content.replace('text-slate-900', 'text-slate-900 dark:text-white').replace('text-slate-900', 'text-slate-900 dark:text-white').replace('text-slate-900', 'text-slate-900 dark:text-white');
...
content = content.replace('text-slate-500', 'text-slate-500 dark:text-slate-400').replace('text-slate-500', 'text-slate-500 dark:text-slate-400');
