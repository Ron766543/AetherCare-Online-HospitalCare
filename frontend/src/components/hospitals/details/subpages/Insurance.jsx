...
const Insurance = ({HOSPITAL}) => {
  return (
    <div>
      <section
        id="insurances"
        className="bg-white dark:bg-slate-800 p-6 md:p-8 rounded-xl border border-slate-600 shadow-sm scroll-mt-36"
      >
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-lg font-bold text-slate-900 dark:text-slate-100">
            Insurance Accepted ({HOSPITAL.insurances.length})
          </h2>
